...
<div class="login-box">
  ...
  <div class="card card-outline card-info">
    ...
    <div class="card-body">
      <p class="login-box-msg">Masukkan NIK dan Nama Lengkap Anda.</p>
      ...
      <form action="proses_login.php" method="post">
        ...
        <div class="row">
          <!-- /.col -->
          <div class="col-12">
            <button type="submit" class="btn btn-info btn-block" >Login   <i class="fas fa-spinner"></i></button>
          </div>
          <!-- /.col -->
        </div>
      </form>
      ...
      <div class="social-auth-links text-center mt-2 mb-3">
        <a href="register.php" class="btn btn-block btn-info">
           Registrasi member baru <i class="fa fa-sign-out mr-2"></i>
        </a>
      </div>
